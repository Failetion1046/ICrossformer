...
from models.ChComb import FlattenHead2,FeedForward
from models.Transformer import MultFlattenHead
import math
import numpy as np
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.task_name == 'long_term_forecast' or self.task_name == 'short_term_forecast':
            ...
            self.Projhead = FlattenHead2(configs.enc_in, self.headn, configs.pred_len, head_dropout=configs.dropout)
